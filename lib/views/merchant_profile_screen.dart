...
import 'package:flutter_application_1/services/services_review_service.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text(title, style: AppTextStyles.headingSmall)), if (trailing != null) trailing!,
            ],
          ),
          const SizedBox(height: AppSpacing.m),
          child,
