...
final topRatedProvidersProvider =
    FutureProvider<List<DiscoverySearchResult>>((ref) async {
  final user = ref.watch(currentUserDocProvider).value;
  return ref.read(discoveryServiceProvider).topRatedProviders(
...
final providersStreamProvider =
    StreamProvider.family.autoDispose<List<DiscoverySearchResult>, DiscoverySearchType>(
  (ref, type) {
