            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _isRecording ? AppColors.errorRed.withValues(alpha: 0.1) : AppColors.white,
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
                    _isRecording ? Icons.stop_circle : Icons.mic, 
                    color: _isRecording ? AppColors.errorRed : AppColors.accentBlue, 
                    size: 24
                  ),
                ),
              ),
              ...
              Expanded(
                child: Container(
                  decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(color: _isRecording ? AppColors.errorRed.withValues(alpha: 0.5) : AppColors.borderLight),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: _isRecording
                    ? Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Icon(Icons.mic, color: AppColors.errorRed, size: 16),
                            const SizedBox(width: 8),
                            Text(
