...
class _BuilderEditProfileScreenState extends ConsumerState<BuilderEditProfileScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('✅ Provider profile updated successfully!'), backgroundColor: AppColors.successGreen),
        );
      }
    } catch (e) {
      if (mounted) {
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isSaving
                    ...
                    : const Text('Save Changes', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 16)),
              ),
            ),
            const SizedBox(height: AppSpacing.xl),
          ],
  ...
  Widget _buildSection({required String title, required IconData icon, required List<Widget> children}) {
    return Card(
      ...
      elevation: 0,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppSpacing.borderRadius), side: BorderSide(color: AppColors.softGray.withValues(alpha: 0.15))),
      child: Padding(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: AppColors.softGray.withValues(alpha: 0.04),
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? AppColors.accentBlue : AppColors.softGray.withValues(alpha: 0.08),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(opt, style: TextStyle(color: isSelected ? AppColors.white : AppColors.textDark, fontSize: 13, fontWeight: FontWeight.w500)),
              ),
            );
          }).toList(),
        ),
