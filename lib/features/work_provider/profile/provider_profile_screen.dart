    ...
    return SliverAppBar(
      ...
      leading: Padding(
        ...
        child: CircleAvatar(
          ...
          child: const BackButton(color: AppColors.white),
        ),
      ),
      actions: [
        Padding(
          ...
          child: CircleAvatar(
            backgroundColor: AppColors.black.withValues(alpha: 0.3),
            child: IconButton(icon: const Icon(Icons.share_outlined, color: AppColors.white, size: 20), onPressed: () {}),
          ),
        ),
      ],
  ...
  Widget _buildHeaderCard(Map<String, dynamic> data) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.black.withValues(alpha: 0.05), blurRadius: 15, offset: const Offset(0, 5))],
      ),
      child: Column(
        children: [
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: skills.map((s) => _tag(s.toString(), AppColors.accentBlue.withValues(alpha: 0.1), AppColors.accentBlue)).toList(),
          ),
          const SizedBox(height: 16),
          ...
          children: [
            ...
            if (data['emergencyAvailable'] == true) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(color: AppColors.errorRed.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(8)),
                child: Row(
                  children: [
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Container(
            height: 50, width: 50,
            decoration: BoxDecoration(color: AppColors.availableGreen.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(12)),
