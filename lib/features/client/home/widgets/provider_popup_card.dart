          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: (isAvailable ? AppColors.successGreen : AppColors.accentOrange).withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  isAvailable ? 'Available' : 'Busy',
                  style: AppTextStyles.caption.copyWith(
                    color: isAvailable ? AppColors.successGreen : AppColors.accentOrange,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(label, style: const TextStyle(fontSize: 13, color: AppColors.accentBlue, fontWeight: FontWeight.normal)),
        ],
      ),
    );
  }
